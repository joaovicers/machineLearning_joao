...
if (len(sys.argv) <= 4):
	...
	sys.exit()
fasta        = sys.argv[1]
fasta_test   = sys.argv[2]
model_c_name = sys.argv[3]
model_d_name = sys.argv[4]
model_stem_name = sys.argv[5]

print "training: ",fasta
print "test: ",fasta_test
print "Cmodel: ",model_c_name
print "Dmodel: ",model_d_name
print "stemModel",model_stem_name

#fasta = "../CD_sim_dataset2.fa"
#fasta_test = "../CD_sim_dataset1.fa"
#model_stem_name = 'stem_model'
